...
export default function Hangman() {
  return (
    <div className="relative grid h-screen grid-rows-[2fr,65%,1fr] overflow-auto bg-hangman px-6">
      <div aria-hidden />
      <div
        className="relative grid grid-rows-[25%,1fr,15%] rounded-[3rem]"
        style={{
      ...
      >
        ...
        <div className="flex flex-col justify-between">
          <Link
            to="category"
            className="mx-auto w-fit rounded-full p-14"
            style={{
          ...
          <Link
            ...
            className="mx-auto w-[90%] rounded-[2.5rem] bg-[#2463ff] py-3 text-center text-3xl text-white"
            type="submit"
          >
            HOW TO PLAY
          </Link>
